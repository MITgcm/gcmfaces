...
latex_documents = [
    (master_doc, 'gcmfaces.tex', u'gcmfaces Documentation',
...
man_pages = [
    (master_doc, 'gcmfaces', u'gcmfaces Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gcmfaces', u'gcmfaces Documentation',
     author, 'gcmfaces', 'One line description of project.',
     'Miscellaneous'),
]
