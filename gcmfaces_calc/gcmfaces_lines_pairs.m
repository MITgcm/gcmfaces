function [lonPairs,latPairs,names]=gcmfaces_lines_pairs();
% GCMFACES_LINES_PAIRS returns a set of predefined section
%      end points [lonPairs,latPairs,names]=gcmfaces_lines_pairs();
